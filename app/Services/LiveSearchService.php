...
class LiveSearchService
{
    ...
    private function adminMenuItems(): array
    {
        return [
            ...
            ['title' => 'Integrations', 'section' => 'Settings', 'route' => 'admin.ai.integrations.index', 'permissions' => ['ai.templates'], 'description' => 'Configure third-party service integrations.', 'keywords' => 'pexels unsplash search transcript api'],
            ...
            ['title' => 'Testimonials', 'section' => 'Content & CMS', 'route' => 'admin.testimonials.index', 'permissions' => ['content.pages'], 'description' => 'Manage homepage and marketing testimonials.', 'keywords' => 'reviews social proof'],
            ['title' => 'FAQs', 'section' => 'Content & CMS', 'route' => 'admin.faqs.index', 'permissions' => ['content.pages'], 'description' => 'Manage frequently asked questions.', 'keywords' => 'questions answers'],
            ...
            ['title' => 'Homepage Builder', 'section' => 'Appearance', 'route' => 'admin.homepage.index', 'permissions' => ['settings.manage'], 'description' => 'Edit homepage sections and content blocks.', 'keywords' => 'landing builder'],
            ['title' => 'Header Builder', 'section' => 'Appearance', 'route' => 'admin.header.index', 'permissions' => ['settings.manage'], 'description' => 'Edit public header layout and blocks.', 'keywords' => 'navigation topbar'],
            ['title' => 'Footer Builder', 'section' => 'Appearance', 'route' => 'admin.footer.index', 'permissions' => ['settings.manage'], 'description' => 'Edit public footer layout and blocks.', 'keywords' => 'bottom links'],
            ...
            ['title' => 'System Tools', 'section' => 'Settings', 'route' => 'admin.system.index', 'permissions' => ['settings.manage'], 'description' => 'Cron jobs, cache, maintenance mode, and system utilities.', 'keywords' => 'cron cache maintenance system tools'],
            ...
            ['title' => 'Social Media', 'section' => 'Marketing', 'route' => 'admin.social.settings.edit', 'permissions' => ['settings.manage'], 'description' => 'Configure social profiles and follower counters.', 'keywords' => 'social links followers'],
