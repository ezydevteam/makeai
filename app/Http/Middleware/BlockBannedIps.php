...
class BlockBannedIps
{
    ...
    {
        // Nothing can be banned before the product is installed, and the
        // banned_ips table does not exist yet. This middleware is prepended to
        // the web group, so without this guard it runs ahead of
        // InstallationMiddleware and turns the installation wizard itself into a
        // 500 on every freshly extracted package.
