...
class PlanController extends Controller
{
    ...
    public function index(): Response
    {
        ...
        return Inertia::render('Admin/Premium/Plans', [
            ...
            // Offer exactly the currencies we can actually render and validate against
            // (CurrencyCatalog carries the symbol/decimals/position for each). The old
            // hand-kept list here was a strict subset, so a dozen fully-supported
            // currencies — TWD, ILS, RUB, UAH… — could never be picked.
    ...
    {
        $this->authorizeAdmin('plans.edit');
