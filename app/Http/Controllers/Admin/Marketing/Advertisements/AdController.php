...
namespace App\Http\Controllers\Admin\Marketing\Advertisements;
...
class AdController extends Controller
{
    ...
    private function payload(AdRequest $request): array
    {
        ...
        if ($request->hasFile('image_file')) {
            ...
            $validated['image_url'] = Storage::url($request->file('image_file')->store('ads', 'public'));
    ...
    private function renderIndex(Request $request, ?Ad $editorAd = null, ?string $editorMode = null): Response
    {
        ...
        return Inertia::render('Admin/Marketing/Advertisements/Index', [
            'ads' => $ads,
