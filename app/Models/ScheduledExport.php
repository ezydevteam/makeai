 ...
 * generated into the admin's Recent Exports and the owning admin is notified
 * in-app and by the hardcoded system email (NotifyExportReadyJob) — the same
 * delivery as an on-demand run. The date range is a rolling window matched to the
 * frequency, so a weekly export always covers "the last week", not a frozen range.
 */
