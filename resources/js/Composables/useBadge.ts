export function badgeClass(value: string): string {
    const map: Record<string, string> = {
        ...
        closed: 'bg-gray-200/60 text-gray-600 dark:bg-gray-700/30 dark:text-gray-300',
        low: 'bg-gray-200/60 text-gray-600 dark:bg-gray-700/30 dark:text-gray-300',
        medium: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300',
        high: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300',
        urgent: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300',
    }
    return map[value] ?? 'bg-gray-200/60 text-gray-600 dark:bg-gray-700/30 dark:text-gray-300'
}
