            ...
            <div v-for="theme in themes" :key="theme.slug" :class="[theme.is_active ? 'border-primary-500 ring-1 ring-primary-500/20' : 'border-gray-200']" class="relative bg-white border rounded-2xl overflow-hidden shadow-sm">
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <Link v-if="theme.settings && theme.settings.length" :href="route('admin.themes.settings', { slug: theme.slug })" class="px-3 py-2 bg-gray-50 text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-colors" :title="$t('Settings')">
