        ...
        <Teleport to="body">
            ...
            >
                <div class="w-full max-w-md overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg dark:border-surface-800 dark:bg-surface-900">
                    <div class="p-5">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ t('Reject transaction') }}</h3>
                        <p class="mt-2 text-sm leading-6 text-gray-500 dark:text-gray-400">
                            {{ t('The payment will be marked as failed and the user will be notified.') }}
                        </p>
                    ...
                    <div class="flex justify-end gap-2 border-t border-gray-100 bg-gray-50 p-4 dark:border-surface-800 dark:bg-surface-950">
                        <button
                            type="button"
                            :disabled="rejectState.processing"
                        ...
                        <button
                            ...
                            @click="confirmReject"
                        >
                            {{ rejectState.processing ? t('Rejecting...') : t('Reject') }}
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full space-y-6 px-4 sm:px-6 lg:px-6 xl:px-8 2xl:px-10">
            ...
            <div v-if="stats" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatsCard
                    ...
                    :comparison="stats.pending.comparison.label"
                    :comparison-detail="t('vs last week')"
                    :comparison-type="stats.pending.comparison.type"
                    color="warning"
                >
                    <template #icon>
                        ...
                        <div class="flex-1 min-w-[240px]">
                            <div class="relative">
                                ...
                                <input
                                    v-model="searchQuery"
                                    type="text"
                                    :placeholder="t('Search by user, email, or transaction ID...')"
                                ...
                                >
                                    <td class="px-6 py-4 align-top">
                                        <div class="min-w-[200px]">
                                            <p class="font-semibold text-gray-900 dark:text-white">{{ payment.user?.name ?? t('Deleted User') }}</p>
                                    ...
                                    <td class="px-6 py-4 align-top">
                                        <div class="flex items-center justify-end gap-2">
                                            <Tooltip v-if="payment.bank_transfer?.proof_url" :content="t('View payment proof')">
                                                <a
                                            ...
                                            <Tooltip v-if="payment.user?.ulid" :content="t('View user')">
                                                <Link
                                            ...
                                            <Tooltip v-if="payment.status === 'pending'" :content="t('Approve')">
                                                <button
                                                    type="button"
                                            ...
                                            <Tooltip v-if="payment.status === 'pending'" :content="t('Reject')">
                                                <button
                                                    type="button"
