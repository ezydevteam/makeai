      ...
      <div class="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <section v-if="props.templates.length > 0" class="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1fr)_280px]">
          <div class="grid grid-cols-1 gap-6 md:grid-cols-2 2xl:grid-cols-3">
            ...
            >
              <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-primary-500 via-secondary-500 to-violet-500 opacity-80"></div>
              ...
              <div class="flex items-start justify-between gap-4">
                <div class="flex min-w-0 items-start gap-4">
                  ...
                  <div class="min-w-0">
                    ...
                    <p class="mt-1 text-xs font-medium uppercase tracking-[0.18em] text-gray-400 dark:text-gray-500">{{ template.slug }}</p>
                  </div>
                </div>
                <span
