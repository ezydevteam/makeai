        ...
        <template #header>
            <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4 dark:border-surface-800 w-full rounded-t-2xl bg-white dark:bg-surface-900">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button @click="emit('close')" class="rounded-full w-8 h-8 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-surface-800">
