...
<template>
    ...
    >
        <template #header>
            <div class="flex items-center justify-between border-b border-gray-100 px-6 py-4 dark:border-surface-800 w-full rounded-t-2xl bg-white dark:bg-surface-900">
                <div>
                ...
                <div class="flex items-center gap-2">
                    <button
                        @click="emit('create')"
                        class="inline-flex items-center gap-2 rounded-xl border border-primary-200 bg-primary-50 px-3 py-2 text-xs font-semibold text-primary-700 hover:bg-primary-100 dark:border-primary-900/40 dark:bg-primary-900/20 dark:hover:bg-primary-900/40 dark:text-primary-300"
                    >
                        <i class="ti ti-plus text-sm"></i>
                        {{ t('Create') }}
                    </button>
                    <button @click="emit('close')" class="rounded-full w-8 h-8 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-surface-800 dark:hover:text-white">
        ...
        <div class="space-y-4">
            ...
            <div v-if="filteredNotes.length" class="grid grid-cols-1 gap-3 max-h-[50vh] overflow-y-auto pr-1">
                <div
