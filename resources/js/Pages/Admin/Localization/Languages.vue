                    ...
                    <div class="min-w-[980px]">
                        <table class="min-w-full table-auto">
                            ...
                            <tbody>
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="space-y-2 text-sm text-gray-700 dark:text-gray-200">
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('Currency') }}</span>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="space-y-2 text-sm text-gray-700 dark:text-gray-200">
                                            ...
                                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('Decimal') }}: <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ language.decimal_separator }}</span></p>
                                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('Thousands') }}: <span class="text-sm font-medium text-gray-800 dark:text-gray-200">{{ language.thousands_separator }}</span></p>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr v-if="props.languages.length === 0">
