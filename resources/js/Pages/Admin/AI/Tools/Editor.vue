...
<template>
    <Head :title="(isEditing ? 'Edit Tool' : 'Create Tool') + ' — Admin'" />
        ...
        <div class="flex items-center justify-between">
            <div>
                <div class="flex items-center gap-3">
                    <Link :href="route('admin.ai.tools.index')" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-surface-800 text-gray-400 transition-colors">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ isEditing ? 'Edit Tool' : 'Create Tool' }}</h1>
                </div>
