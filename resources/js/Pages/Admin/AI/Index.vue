...
<template>
                        ...
                        <div class="shrink-0 border-t border-gray-100 bg-gray-50/80 px-5 py-3 dark:border-surface-800 dark:bg-surface-950">
                            <div class="flex items-center justify-end gap-3">
                                ...
                                <button
                                    ...
                                    class="rounded-lg btn-primary px-5 py-2 text-sm font-semibold disabled:opacity-60"
                                    @click="saveSettings"
                                >
    ...
    <div class="mx-auto max-w-7xl px-6 py-8">
        <section class="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <button type="button" @click="settingsModalOpen = true" class="inline-flex items-center gap-2 rounded-lg btn-primary px-5 py-2.5 text-sm font-semibold">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
                        ...
                        >
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <span class="rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-wide" :class="stat.key_count > 0 ? 'bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-300' : 'bg-gray-200 text-gray-600 dark:bg-surface-700 dark:text-gray-300'">
