                                ...
                                <td class="px-6 py-5 align-top">
                                    <div class="flex items-start gap-3">
                                        <div v-if="review.user?.avatar" class="h-11 w-11 shrink-0 overflow-hidden rounded-full bg-gray-100 dark:bg-surface-800">
                                            <img :src="mediaUrl(review.user.avatar)" class="h-full w-full object-cover" />
                                        </div>
                                        <div
                                            v-else
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex items-center gap-3">
                    <div v-if="reviewDetails?.user?.avatar" class="h-12 w-12 shrink-0 overflow-hidden rounded-full bg-gray-100 dark:bg-surface-800">
                        <img :src="mediaUrl(reviewDetails.user.avatar)" class="h-full w-full object-cover" />
                    </div>
                    <div
                        v-else
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ reviewDetails?.user?.email || '—' }}</p>
                    </div>
                </div>
