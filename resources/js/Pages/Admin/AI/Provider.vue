        ...
        <div class="mb-8 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div class="flex items-center gap-3 self-start">
                ...
                <button
                    type="button"
                    @click="openKeyModal"
                    class="inline-flex items-center justify-center gap-2 rounded-lg btn-primary px-5 py-2.5 text-sm font-semibold"
                >
                    ...
                    <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                        ...
                        <div class="flex items-center gap-3 xl:ml-4">
                            <button
                                ...
                                :class="model.is_active ? 'bg-primary-600' : 'bg-gray-300 dark:bg-surface-700'"
            ...
            <div v-if="showKeyModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                <div class="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-surface-900" style="animation: modal-in 0.18s ease">
                    <div class="flex items-center justify-between border-b border-gray-100 px-5 py-4 dark:border-surface-700">
                        ...
                        <button
                            @click="closeKeyModal"
                            class="flex h-8 w-8 items-center justify-center rounded-lg text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-surface-800 dark:hover:text-gray-200"
                        >
                    ...
                    <form @submit.prevent="submitKey" class="p-5 space-y-4">
                        ...
                        <div class="flex gap-3 border-t border-gray-100 pt-4 dark:border-surface-700">
                            ...
                            <button
                                ...
                                class="flex-1 rounded-lg bg-primary-600 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-700 disabled:opacity-50"
                            >
