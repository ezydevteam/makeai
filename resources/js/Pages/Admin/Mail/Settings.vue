    ...
    <Head :title="t('Mail Settings')" />
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <button
                ...
                class="btn-primary-admin inline-flex shrink-0 items-center justify-center gap-2 disabled:cursor-not-allowed disabled:opacity-60"
                @click="submit"
            >
                    ...
                    <div class="grid grid-cols-1 gap-6 p-6 md:grid-cols-3">
                        <div class="md:col-span-2">
                            ...
                            <input
                                ...
                                type="text"
                                :placeholder="t('e.g., smtp.mailgun.org')"
                                class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30"
                            >
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="password"
                                :placeholder="configuredSecrets.mail_password ? t('Stored securely - leave blank to keep') : t('SMTP password')"
                                class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition placeholder:text-gray-400 focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30"
                            >
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 p-6 md:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                :placeholder="t('AWS Access Key ID')"
                                class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30"
                            >
                        </div>
                        <div>
                            <label class="mb-2 block text-sm font-semibold text-gray-700 dark:text-gray-300">{{ t('Region') }}</label>
                            <input v-model="form.ses_region" type="text" :placeholder="t('us-east-1')" class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition placeholder:text-gray-400 focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30">
                        </div>
                        <div class="md:col-span-2">
                            ...
                            <input
                                ...
                                type="password"
                                :placeholder="configuredSecrets.ses_secret ? t('Stored securely - leave blank to keep') : t('AWS Secret Access Key')"
                                class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition placeholder:text-gray-400 focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30"
                            >
                        </div>
                    </div>
                ...
                <div v-if="form.mail_driver === 'sendgrid'" class="rounded-2xl border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-800">
                    ...
                    <div class="p-6">
                        ...
                        <input
                            ...
                            type="password"
                            :placeholder="configuredSecrets.sendgrid_api_key ? t('Stored securely - leave blank to keep') : t('SendGrid API Key')"
                            class="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-700 transition placeholder:text-gray-400 focus:border-primary-400 focus:outline-none focus:ring-4 focus:ring-primary-100 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-900/30"
                        >
                    </div>
                </div>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-primary-200 bg-primary-50 p-6 shadow-sm dark:border-primary-900/30 dark:bg-primary-900/10">
                    <div class="flex items-start gap-4">
                        <div class="shrink-0 flex h-11 w-11 items-center justify-center rounded-2xl bg-primary-500 text-white shadow-sm">
                            <i class="ti ti-mail-bolt text-xl"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-semibold text-gray-900 dark:text-white">{{ t('Delivery Advice') }}</h3>
                            <p class="mt-2 text-sm leading-6 text-gray-600 dark:text-gray-300">{{ t('For better deliverability, use a dedicated provider such as Amazon SES or SendGrid instead of basic shared SMTP.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
