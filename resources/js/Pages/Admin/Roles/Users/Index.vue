...
<template>
    ...
    <AdminLayout>
        ...
        <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/45 p-4 backdrop-blur-sm" @click.self="closeCreateModal()">
            <div class="flex max-h-[90vh] w-full sm:max-w-3xl flex-col overflow-visible rounded-2xl bg-white shadow-xl dark:bg-gray-800">
