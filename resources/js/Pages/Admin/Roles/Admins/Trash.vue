                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="inline-flex items-center gap-2">
                                            <Tooltip :content="t('Restore administrator')" placement="top">
                                                <button
                                                    type="button"
                                                    :aria-label="t('Restore administrator')"
                                            ...
                                            <Tooltip :content="t('Permanently delete administrator')" placement="top">
                                                <button
                                                    type="button"
                                                    :aria-label="t('Permanently delete administrator')"
...
const bulkActionOptions = computed(() => [
    ...
    { value: 'force_delete', label: t('Permanently Delete Administrators') },
])
...
const applyFilters = () => {
    router.get(route('admin.admins.trash'), {
