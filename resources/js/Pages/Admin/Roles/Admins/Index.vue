...
const confirmDelete = (admin: AdminItem) => {
    openConfirmModal({
        ...
        message: t('Delete administrator account of :name? This will suspend their access immediately.', { name: admin.name }),
                        ...
                        <table class="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                            <thead class="border-b border-gray-100 bg-gray-50 text-xs uppercase text-gray-700 dark:border-gray-800 dark:bg-gray-700/60 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-center">{{ t('Last Login') }}</th>
