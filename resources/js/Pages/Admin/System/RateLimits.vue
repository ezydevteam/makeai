    ...
    <div class="py-6">
        <div class="w-full space-y-6 px-4 sm:px-6 lg:px-6 xl:px-8 2xl:px-10">
            ...
            <div v-else-if="activeTab === 'bans'" class="space-y-6 p-4 sm:p-6">
                ...
                <form @submit.prevent="submitBan" class="rounded-xl border border-gray-200 bg-gray-50/70 p-5 dark:border-surface-700 dark:bg-surface-950/40">
            ...
            <div v-else class="space-y-6 p-4 sm:p-6">
                ...
                <form @submit.prevent="submitOverride" class="rounded-xl border border-gray-200 bg-gray-50/70 p-5 dark:border-surface-700 dark:bg-surface-950/40">
                    <div class="grid gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-2">
