...
const statCards = computed(() => [
    { key: 'app_name', label: t('Application'), value: 'MakeAI', icon: 'ti ti-app-window', tone: 'text-primary-700 dark:text-primary-300' },
        ...
        <section class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            >
                <div class="flex items-start justify-between gap-4">
                    ...
                    <span :class="card.iconClass" class="shrink-0 inline-flex h-10 w-10 items-center justify-center rounded-xl">
            ...
            <div class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                >
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span class="shrink-0 inline-flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50 text-primary-600 dark:bg-primary-900/30 dark:text-primary-300">
                            <i :class="card.icon" class="text-lg"></i>
                        </span>
                    </div>
                </article>
        ...
        <section class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-surface-800 dark:bg-surface-900">
            ...
            <div class="space-y-4 p-6">
                ...
                >
                    <div class="flex items-start gap-4">
                        <span class="inline-flex h-11 w-11 items-center justify-center rounded-2xl">
                            <i :class="statusIconClass[check.status]" class="inline-flex h-11 w-11 items-center justify-center rounded-2xl text-xl"></i>
                        </span>
                ...
                <div
                    ...
                    class="rounded-2xl border border-dashed border-gray-200 px-6 py-12 text-center dark:border-surface-700"
                >
