...
const overviewCards = computed(() => [
    { key: 'pass', label: t('Pass'), value: props.healthSummary.pass, icon: 'ti ti-circle-check', cardClass: 'border-green-200 bg-green-50 dark:border-green-900/40 dark:bg-green-900/20', iconClass: 'bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300', valueClass: 'text-green-700 dark:text-green-300' },
    { key: 'warn', label: t('Warn'), value: props.healthSummary.warn, icon: 'ti ti-alert-triangle', cardClass: 'border-amber-200 bg-amber-50 dark:border-amber-900/40 dark:bg-amber-900/20', iconClass: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300', valueClass: 'text-amber-700 dark:text-amber-300' },
    { key: 'fail', label: t('Fail'), value: props.healthSummary.fail, icon: 'ti ti-alert-circle', cardClass: 'border-red-200 bg-red-50 dark:border-red-900/40 dark:bg-red-900/20', iconClass: 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300', valueClass: 'text-red-700 dark:text-red-300' },
    { key: 'total', label: t('Total checks'), value: props.healthSummary.pass + props.healthSummary.warn + props.healthSummary.fail, icon: 'ti ti-list-check', cardClass: 'border-violet-200 bg-violet-50 dark:border-violet-900/40 dark:bg-violet-900/20', iconClass: 'bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300', valueClass: 'text-violet-700 dark:text-violet-300' },
])
            ...
            <section class="rounded-xl border border-gray-200 bg-white shadow-sm dark:border-surface-800 dark:bg-surface-900">
                ...
                <div class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2 xl:grid-cols-3">
                    <article
                        ...
                        :key="card.key"
                        class="rounded-xl border border-gray-200 bg-gray-50/80 p-5 dark:border-surface-700 dark:bg-surface-800/80"
                    >
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-gray-500 dark:text-gray-400">{{ card.label }}</p>
