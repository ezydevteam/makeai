...
const form = useForm({
    scope: 'admin',
    settings: {
        primary_color: get('primary_color', '#f97316'),
        accent_color: get('accent_color', '#6366f1'),
        bg_color: get('bg_color', '#ffffff'),
        text_primary_color: get('text_primary_color', '#111827'),
        sidebar_bg: get('sidebar_bg', '#111111'),
        sidebar_text_color: get('sidebar_text_color', '#ffffff'),
