                                ...
                                <div class="grid gap-4 md:grid-cols-2">
                                    <label class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 dark:border-gray-700 dark:bg-gray-900/50 dark:text-gray-200">
                                        ...
                                        <button
                                            ...
                                            :class="form.is_enabled ? 'bg-primary-600' : 'bg-gray-300 dark:bg-surface-700'"
                                            @click="toggleGatewayEnabled"
                                        >
                                            <span class="inline-block h-5 w-5 translate-y-0.5 rounded-full bg-white transition" :class="form.is_enabled ? 'translate-x-5' : 'translate-x-0.5'"></span>
                                        </button>
                                    </label>
                                    ...
                                    <label class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-700 dark:border-gray-700 dark:bg-gray-900/50 dark:text-gray-200">
                                        ...
                                        <button
                                            ...
                                            class="relative inline-flex h-6 w-11 rounded-full transition"
                                            :class="form.is_test_mode ? 'bg-primary-600' : 'bg-gray-300 dark:bg-surface-700'"
                                            @click="form.is_test_mode = !form.is_test_mode"
                                        >
                                            <span class="inline-block h-5 w-5 translate-y-0.5 rounded-full bg-white transition" :class="form.is_test_mode ? 'translate-x-5' : 'translate-x-0.5'"></span>
                                        </button>
                                    </label>
