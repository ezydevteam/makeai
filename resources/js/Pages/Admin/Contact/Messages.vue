                ...
                <template v-if="selected">
                    <div class="border-b border-gray-100 pb-5 dark:border-surface-800">
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            ...
                            <span class="inline-flex w-fit rounded-full bg-gray-50 px-2.5 py-1 text-xs font-medium text-gray-500 dark:bg-surface-900/20 dark:text-gray-500">
            ...
            <template #footer>
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 w-full">
                    ...
                    <div class="flex items-center gap-3">
                        <button
                            type="button"
                            class="inline-flex items-center justify-center rounded-full border border-gray-200 bg-white px-5 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-surface-700 dark:bg-surface-900 dark:text-gray-300 dark:hover:bg-surface-800"
                        ...
                        <button
                            type="button"
                            class="btn-primary-admin !rounded-full inline-flex items-center justify-center gap-2 disabled:cursor-not-allowed disabled:opacity-60"
