...
<template>
    ...
    <div class="mx-auto max-w-5xl px-6 py-10 space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="font-heading text-2xl font-bold text-gray-900 dark:text-white">{{ $t('Account Settings') }}</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $t('Manage security settings for your account.') }}</p>
            </div>
            <span
            ...
            <section class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-surface-800 dark:bg-surface-900">
                ...
                <form class="mt-5 space-y-4" @submit.prevent="enable">
                    <div>
                        ...
                        <input id="enable-code" v-model="enableForm.code" type="text" inputmode="numeric" maxlength="6" required class="w-full rounded-xl border-gray-200 bg-white px-4 py-3 text-center text-lg font-bold tracking-widest text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-surface-700 dark:bg-surface-800 dark:text-white" />
