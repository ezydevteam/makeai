        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-t border-gray-100 pt-4 dark:border-surface-800">
          ...
          <div class="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              class="inline-flex h-11 items-center gap-1.5 rounded-full bg-primary-500 px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-600 disabled:opacity-50"
            >
              ...
              <i v-else class="ti ti-player-play-filled text-base"></i>
