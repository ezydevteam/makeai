...
import DiffModal from '@/Components/AI/DiffModal.vue'
...
const filteredHistory = computed(() => {
  return props.history.filter(item => {
    ...
    if (searchQuery.value.trim() !== '') {
      ...
      return matchesSlug || matchesLabel || matchesModel || matchesOutput
    }
...
<template>
  <div>
    ...
    <div v-if="filteredHistory.length === 0" class="rounded-xl border border-dashed border-gray-300 bg-white p-12 text-center dark:border-gray-700 dark:bg-gray-900">
