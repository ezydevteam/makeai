...
<template>
    ...
    <div>
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="relative w-full max-w-xs sm:w-72">
                ...
                <input
                    ...
                    class="w-full rounded-xl border border-gray-200 bg-gray-50/50 py-2.5 pl-10 pr-9 text-sm outline-none transition focus:border-primary-500 focus:bg-white dark:border-surface-800 dark:bg-surface-900 dark:text-white dark:focus:border-primary-500"
                />
        ...
        <div
            ...
            class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white px-6 py-16 text-center dark:border-surface-800 dark:bg-surface-900/50"
        >
        ...
        <div v-else class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <div
                ...
                :key="doc.id"
                class="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary-300 hover:shadow-md dark:border-surface-850 dark:bg-surface-900/80 dark:hover:border-primary-900/50"
            >
                <div>
                    ...
                    <div class="flex items-center justify-between gap-2 mb-4">
                        <span
                            ...
                            class="inline-flex items-center rounded-lg border px-2 py-0.5 text-xs font-semibold uppercase tracking-wider"
                        >
                    ...
                    <div class="mt-3 flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500">
                        ...
                        <span>{{ t('Updated :time', { time: timeAgo(doc.updated_at) }) }}</span>
                    </div>
                </div>
                ...
                <div class="mt-6 flex items-center justify-between border-t border-gray-100 pt-4 dark:border-surface-800">
                    <Link
                        ...
                        class="text-xs font-semibold text-[#1F75FE] hover:underline flex items-center gap-1"
                    >
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <Tooltip :content="t('Delete')">
                            <button
                                ...
                                class="flex h-8 w-8 items-center justify-center rounded-lg text-red-500 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/20 transition-colors"
                            >
