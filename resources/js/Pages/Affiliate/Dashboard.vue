...
const statTileClassMap: Record<string, string> = {
    total_earnings: 'bg-emerald-100 text-emerald-700 ring-emerald-200/80 dark:bg-emerald-500/15 dark:text-emerald-300 dark:ring-emerald-500/25',
    pending_earnings: 'bg-amber-100 text-amber-700 ring-amber-200/80 dark:bg-amber-500/15 dark:text-amber-300 dark:ring-amber-500/25',
    total_referrals: 'bg-sky-100 text-sky-700 ring-sky-200/80 dark:bg-sky-500/15 dark:text-sky-300 dark:ring-sky-500/25',
    successful_conversions: 'bg-violet-100 text-violet-700 ring-violet-200/80 dark:bg-violet-500/15 dark:text-violet-300 dark:ring-violet-500/25',
}
const getStatTileClass = (key: string) => statTileClassMap[key] ?? 'bg-slate-200 text-slate-800 ring-slate-200/90 dark:bg-gray-700 dark:text-slate-200 dark:ring-white/10'
        ...
        <div class="space-y-6">
            ...
            <div class="mb-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                ...
                >
                    ...
                    <div class="mb-4 flex h-10 w-10 items-center justify-center rounded-xl shadow-sm ring-1" :class="getStatTileClass(String(stat.key))">
            ...
            <!-- Referral Link -->
            <section class="overflow-hidden rounded-2xl border border-white/70 bg-white p-4 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                    ...
                    <label class="min-w-0 flex-1">
                        ...
                        <div class="relative">
                            <input
                                :value="referralUrl"
                                readonly
                                class="w-full rounded-xl border border-gray-200 bg-gray-50 py-2.5 pe-10 ps-3 text-sm text-gray-900 shadow-sm transition focus:border-primary-400 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-950 dark:text-white dark:focus:bg-gray-900"
                            />
                            <button
                                type="button"
            ...
            <!-- Performance -->
            <section class="mt-6 overflow-hidden rounded-2xl border border-white/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex w-full rounded-full border border-gray-200 bg-gray-50 p-1 text-xs shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:w-auto">
                        <button v-for="p in (['daily','weekly','monthly'] as const)" :key="p" :class="chartPeriod === p ? 'bg-white dark:bg-gray-700 shadow-sm font-semibold text-gray-900 dark:text-white' : 'text-gray-500'" class="rounded-full px-3 py-1.5 transition-colors" @click="chartPeriod = p">{{ t(p) }}</button>
                    </div>
                </div>
                <div class="mt-4 h-72">
            ...
            <div class="mt-6 space-y-6">
                <div class="min-w-0 space-y-6">
                    <!-- Referrals Table -->
                    <section class="overflow-hidden rounded-2xl border border-white/70 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                ...
                <section v-if="!program.payouts_enabled" class="rounded-2xl border border-white/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
            ...
            <div v-if="marketing.banners.length || marketing.emails.length || marketing.posts.length" class="mt-6 grid gap-6 lg:grid-cols-3">
                <section v-if="marketing.banners.length" class="min-w-0 overflow-hidden rounded-2xl border border-white/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                    <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">{{ t('Banners') }}</h2>
                    <div class="space-y-3">
                        <div v-for="(b, i) in marketing.banners" :key="i" class="rounded-xl border border-gray-100 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-950/40">
                ...
                <section v-if="marketing.emails.length" class="min-w-0 overflow-hidden rounded-2xl border border-white/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                    <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">{{ t('Email templates') }}</h2>
                    <div class="space-y-3">
                        <details v-for="(e, i) in marketing.emails" :key="i" class="rounded-xl border border-gray-100 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-950/40">
                ...
                <section v-if="marketing.posts.length" class="min-w-0 overflow-hidden rounded-2xl border border-white/70 bg-white p-5 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:ring-white/5">
                    <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">{{ t('Social posts') }}</h2>
                    <div class="space-y-3">
                        <div v-for="(p, i) in marketing.posts" :key="i" class="rounded-xl border border-gray-100 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-950/40">
                ...
                <div class="w-full max-w-xl rounded-3xl border border-gray-200 bg-white p-6 shadow-2xl dark:border-gray-700 dark:bg-gray-900">
                    ...
                    <form class="mt-6 space-y-4" @submit.prevent="submit">
                        <label class="block">
                            ...
                            <input v-model="form.amount" type="number" min="0" step="0.01" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900 shadow-sm transition focus:border-primary-400 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-950 dark:text-white dark:focus:bg-gray-900" />
                        </label>
                        <div>
                        ...
                        <label v-if="selectedMethod === 'paypal'" class="block">
                            ...
                            <input v-model="form.details.paypal_email" type="email" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900 shadow-sm transition focus:border-primary-400 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-950 dark:text-white dark:focus:bg-gray-900" />
                        </label>
                        <label v-if="selectedMethod === 'bank_transfer'" class="block">
                            ...
                            <textarea v-model="form.details.bank_account" rows="4" class="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm text-gray-900 shadow-sm transition focus:border-primary-400 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-950 dark:text-white dark:focus:bg-gray-900" />
                        </label>
            ...
            <!-- Terms -->
            <section v-if="program.terms_page" class="rounded-2xl border border-white/70 bg-white p-5 text-sm text-gray-600 shadow-[0_18px_40px_rgba(15,23,42,0.06)] ring-1 ring-black/5 dark:border-gray-700/70 dark:bg-gray-900 dark:text-gray-400 dark:ring-white/5">
