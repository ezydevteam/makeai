    ...
    <div class="auth-page">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 text-sm font-medium">Log in to your MakeAI account to continue</p>
            </div>
            ...
            <div class="auth-card">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        <input id="email" v-model="form.email" type="email" required autofocus autocomplete="email" class="auth-input" placeholder="name@company.com" />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required autocomplete="current-password" class="auth-input pr-12" placeholder="••••••••" />
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span class="text-sm text-gray-500 group-hover:text-gray-900 transition-colors font-medium">Remember me</span>
                        </label>
                        <Link :href="route('password.request')" class="text-sm text-primary-600 hover:text-primary-700 font-bold transition-colors">Forgot password?</Link>
                    </div>
                ...
                <div class="mt-10 pt-8 border-t border-gray-50 text-center">
                    <p class="text-sm text-gray-500 font-medium">
                        ...
                        <Link :href="route('register')" class="text-primary-600 hover:text-primary-700 font-black transition-colors ml-1">Create an account</Link>
                    </p>
                </div>
            </div>
        </div>
