    ...
    <div class="auth-page">
        ...
        <div class="w-full max-w-md relative z-10">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-1 text-sm">Enter your email to receive a reset link</p>
            </div>
            <div class="auth-card">
                <form @submit.prevent="submit" class="space-y-5">
                    <div>
                        <label for="email" class="auth-label">Email</label>
                        <input id="email" v-model="form.email" type="email" required autofocus class="auth-input" placeholder="you@example.com" />
                ...
                <p class="text-center mt-6 text-sm text-gray-500">
                    <Link :href="route('login')" class="text-primary-400 hover:text-primary-300 transition-colors">← Back to login</Link>
                </p>
            </div>
        </div>
    </div>
