    ...
    <div class="auth-page">
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 text-sm font-medium">Join thousands of creators using MakeAI</p>
            </div>
            ...
            <div class="auth-card">
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        ...
                        <input id="name" v-model="form.name" type="text" required autofocus autocomplete="name" class="auth-input" placeholder="John Doe" />
                        <p v-if="form.errors.name" class="auth-error">{{ form.errors.name }}</p>
                    </div>

                    <div>
                        <label for="email" class="auth-label">Email Address</label>
                        <input id="email" v-model="form.email" type="email" required autocomplete="email" class="auth-input" placeholder="name@company.com" />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" required autocomplete="new-password" class="auth-input pr-12" placeholder="Min. 8 characters" />
                    ...
                    <div>
                        ...
                        <input id="password_confirmation" v-model="form.password_confirmation" type="password" required autocomplete="new-password" class="auth-input" placeholder="••••••••" />
                    </div>
                ...
                <div class="mt-10 pt-8 border-t border-gray-50 text-center">
                    <p class="text-sm text-gray-500 font-medium">
                        ...
                        <Link :href="route('login')" class="text-primary-600 hover:text-primary-700 font-black transition-colors ml-1">Sign In</Link>
                    </p>
                </div>
            </div>
        </div>
