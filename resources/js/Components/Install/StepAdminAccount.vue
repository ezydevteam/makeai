...
const admin = reactive({
    ...
    admin_password: props.formData?.step_5?.admin_password ?? '',
...
<template>
    <div>
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">{{ t('Admin Account') }}</h2>
        <p class="mt-1 text-sm text-gray-500">{{ t("Create your super administrator account. You'll use this to log into the admin panel.") }}</p>

        <div class="mt-6 space-y-4">
            <label class="block">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('Full Name') }}</span>
                    <input
            ...
            <label class="block">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('Email Address') }}</span>
                    <input
                ...
                <label class="block">
                    ...
                    <div class="relative mt-1.5">
                        <input
                            ...
                            class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 pr-10 text-sm dark:border-surface-700 dark:bg-surface-800 dark:text-white"
                        />
                        <button
                            type="button"
            ...
            <label class="block">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ t('Confirm Password') }}</span>
                <input
