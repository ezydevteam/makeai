...
<template>
    ...
    >
        <div
            v-for="item in list"
            :key="item.id"
            class="menu-tree-item rounded-xl border border-gray-200 bg-gray-50 p-4 transition-all dark:border-surface-700 dark:bg-surface-800"
        >
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-1">
                    <button type="button" class="rounded-lg px-2 py-2 text-gray-400 transition-colors hover:bg-white hover:text-primary-600 dark:hover:bg-surface-900" :aria-label="t('Edit item')" @click="emit('edit', item)">
                    ...
                    <button type="button" class="rounded-lg px-2 py-2 text-gray-400 transition-colors hover:bg-white hover:text-danger-600 dark:hover:bg-surface-900" :aria-label="t('Delete item')" @click="emit('delete', item)">
