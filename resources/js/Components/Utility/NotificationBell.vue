...
const notificationIconSizeClass = computed(() => props.ui?.iconSizeClass || (props.context === 'admin' ? '!text-[20px]' : 'text-[18px]'))
...
<template>
    <div v-if="shouldRender" :class="['relative', notificationWrapperClass]" @click.stop>
        <button
            ...
            @click="open = !open"
        >
            <i :class="[notificationIconClass, notificationIconSizeClass, 'leading-none']" :style="notificationIconStyle" aria-hidden="true" />
