    ...
    >
        <div class="mx-auto max-w-7xl px-6">
            <div :class="effectiveCardWrapperClass">
                ...
                <div :class="[section.config.disable_card_style ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-10' : `${featureGridClass(asString(section.config.layout, '3-column'))} grid grid-cols-1 gap-8 md:grid-cols-2`]">
                    <component
                        ...
                        :class="[
                            section.config.disable_card_style 
                    ...
                    >
                        ...
                        <template v-if="section.config.disable_card_style">
