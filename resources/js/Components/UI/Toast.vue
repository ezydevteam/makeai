...
<template>
    <div
        class="toast-item group relative flex w-full max-w-sm items-start gap-3 overflow-hidden rounded-xl border p-4 shadow-lg backdrop-blur-xl transition-all duration-200 hover:scale-[1.02] bg-white/90 text-gray-900 border-gray-200 shadow-gray-200/50 dark:bg-gray-900/92 dark:text-gray-100 dark:border-gray-700/30 dark:shadow-gray-950/50"
    ...
    >
        ...
        <!-- Progress bar — the card's overflow-hidden clips this line to the card's radius -->
