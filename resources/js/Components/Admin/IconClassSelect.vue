...
const icons: [string, string][] = [
    ...
    ['ti ti-users', 'Users'],
    ['ti ti-users-group', 'Team'],
    ['ti ti-user', 'Account'],
    ['ti ti-user-circle', 'Profile'],
    ['ti ti-user-cog', 'User Settings'],
    ['ti ti-login', 'Login'],
    ['ti ti-user-plus', 'Register'],
    ['ti ti-user-check', 'Verified User'],
    ['ti ti-user-shield', 'Admin User'],
    ...
    ['ti ti-arrow-back-up', 'Arrow Back Up'],
    ['ti ti-arrow-forward-up', 'Arrow Forward Up'],
    ['ti ti-arrow-big-up', 'Arrow Big Up'],
    ['ti ti-arrow-big-down', 'Arrow Big Down'],
    ['ti ti-arrow-big-left', 'Arrow Big Left'],
    ['ti ti-arrow-big-right', 'Arrow Big Right'],
    ...
    ['ti ti-chevrons-left', 'Double Chevron Left'],
    ['ti ti-chevrons-right', 'Double Chevron Right'],
    ['ti ti-arrow-loop-left', 'Arrow Loop Left'],
    ['ti ti-arrow-loop-right', 'Arrow Loop Right'],
    ...
    ['ti ti-adjustments-horizontal', 'Preferences'],
    ['ti ti-palette', 'Appearance'],
    ['ti ti-menu-2', 'Menu'],
    ['ti ti-sitemap', 'Structure'],
    ['ti ti-link', 'Link'],
    ['ti ti-external-link', 'External Link'],
    ['ti ti-shopping-cart', 'Checkout'],
    ['ti ti-shopping-bag', 'Store'],
    ['ti ti-chart-bar', 'Analytics'],
    ['ti ti-chart-pie', 'Reports'],
    ['ti ti-chart-donut', 'Insights'],
    ...
    ['ti ti-cash', 'Cash'],
    ['ti ti-coins', 'Coins'],
    ['ti ti-discount-2', 'Discount'],
    ['ti ti-ticket', 'Coupon'],
    ['ti ti-percentage', 'Percentage'],
    ...
    ['ti ti-clock', 'Clock'],
    ['ti ti-alarm', 'Alarm'],
    ['ti ti-calendar-event', 'Event'],
    ['ti ti-calendar-time', 'Schedule'],
    ...
    ['ti ti-layout-sidebar-left-collapse', 'Sidebar'],
    ['ti ti-table', 'Table'],
