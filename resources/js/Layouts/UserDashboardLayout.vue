            ...
            <div class="mx-auto max-w-7xl px-6">
                ...
                <div class="grid gap-6 lg:grid-cols-[260px_minmax(0,1fr)]">
                    ...
                    <aside
                        ...
                        class="fixed left-4 z-50 w-[260px] flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm transition-transform duration-200 dark:border-gray-800 dark:bg-gray-900 lg:sticky lg:left-0 lg:z-auto lg:translate-x-0 lg:shadow-sm"
                        :style="{ top: topOffset, maxHeight: `calc(100vh - ${topOffset} - 24px)` }"
                    >
                        <nav class="flex-1 overflow-y-auto p-3 space-y-1">
                            <AdSection zone="sidebar_top" class="mb-2" />
                        ...
                        <div class="shrink-0 border-t border-gray-100 p-3 dark:border-gray-700">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <Link :href="route('user.dashboard.affiliate')" class="text-xs font-semibold text-[#1F75FE] hover:underline">
                                    {{ t('Payout') }}
                                </Link>
                            </div>
                        </div>
