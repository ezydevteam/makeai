...
<template>
    <div>
        ...
        <div v-if="cronCommand" class="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-4">
            ...
            <div class="mt-3 flex items-start gap-2">
                <code
                    class="flex-1 overflow-x-auto rounded-md border border-amber-200 bg-white px-3 py-2 font-mono text-xs text-slate-800"
                >{{ cronCommand }}</code>
                <button
                    type="button"
                    class="shrink-0 rounded-md border border-amber-300 bg-white px-3 py-2 text-xs font-medium text-amber-800 hover:bg-amber-100"
                    @click="copyCron"
                >
                    {{ copied ? 'Copied' : 'Copy' }}
                </button>
