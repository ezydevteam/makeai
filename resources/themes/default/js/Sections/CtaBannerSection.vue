...
const { sectionBgClass, titleColorClass, subtitleColorClass, titleAlignClass, titleSizeClass, sectionIconClass, sectionHeaderClass, sectionPaddingStyle } = useSectionStyle()
