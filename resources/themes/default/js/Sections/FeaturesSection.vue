    ...
    >
        <div class="mx-auto max-w-7xl px-6">
            <div :class="effectiveCardWrapperClass">
                ...
                <div :class="[section.config.enable_card_style === false ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-10' : `${featureGridClass(asString(section.config.layout, '3-column'))} grid grid-cols-1 gap-8 md:grid-cols-2`]">
                    <component
                        ...
                        :class="[
                            section.config.enable_card_style === false
                    ...
                    >
                        ...
                        <template v-if="section.config.enable_card_style === false">
