            ...
            <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px]">
                ...
                <aside class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="space-y-4 text-sm font-medium text-gray-600">
                        ...
                        <div v-if="(summary.proration_credit ?? 0) > 0" class="flex justify-between gap-4 text-primary-600">
                            <span>{{ proration?.from_plan ? t('Plan credit (unused :plan)', { plan: proration.from_plan }) : t('Plan credit (unused)') }}</span>
                            <span class="text-right font-bold">-{{ summary.proration_formatted }}</span>
                        </div>
