...
const platformClasses: Record<string, string> = {
    ...
    x: 'text-gray-900 hover:text-white dark:text-gray-100',
    instagram: 'text-pink-600 hover:text-white',
    linkedin: 'text-sky-700 hover:text-white',
    youtube: 'text-red-600 hover:text-white',
    tiktok: 'text-gray-900 hover:text-white dark:text-gray-100',
    github: 'text-gray-800 hover:text-white dark:text-gray-100',
...
const platformSurfaceClasses: Record<string, string> = {
    ...
    x: 'bg-gray-50 border-gray-100 hover:bg-gray-900',
    ...
    tiktok: 'bg-gray-50 border-gray-100 hover:bg-gray-900',
    github: 'bg-gray-50 border-gray-100 hover:bg-gray-800',
...
<template>
    <div v-if="hasProfiles" :class="[displayMode === 'icons' ? 'flex shrink-0 items-center gap-2.5' : '']">
