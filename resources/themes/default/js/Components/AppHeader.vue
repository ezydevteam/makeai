                                ...
                                >
                                    <template v-if="menuItemIsMega(item)">
                                        <div v-for="column in megaColumns(block.config.menu_slug, menuItemId(item))" :key="menuItemId(column)" class="header-mega-col">
                                            ...
                                            <a v-else :href="menuItemHref(column)" :target="menuItemTarget(column)" :rel="menuItemRel(column)" class="header-submenu-link flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold transition hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-900/20">
                            ...
                            <div v-if="activeSocialMenu" class="header-user-dropdown absolute right-0 rtl:right-auto rtl:left-0 top-full mt-2 w-72 bg-white dark:bg-surface-800 border border-gray-200 dark:border-white/10 rounded-xl shadow-2xl p-2.5 z-[80]">
                                <div class="grid grid-cols-2 gap-2">
                                    <a
                                        ...
                                        class="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 hover:bg-primary-50 hover:text-primary-600 dark:text-gray-300 dark:hover:bg-primary-900/20 transition-colors"
                                    >
