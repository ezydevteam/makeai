...
<template>
    <Teleport to="body">
        <div v-if="isVisible" class="frontend-theme-vars fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm animate-in fade-in duration-300">
