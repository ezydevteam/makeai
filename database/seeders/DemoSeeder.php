...
class DemoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $adRows = [
            ...
            ['sidebar_bottom', 'Sidebar Purchase Block', 'custom_html', 'all', 'expired', '', 0, 0, 'Get MakeAI for your business', 'The complete AI SaaS platform — 400+ AI tools, an intelligent AI assistant, affiliates, coupons and billing, with a full admin panel.'],
