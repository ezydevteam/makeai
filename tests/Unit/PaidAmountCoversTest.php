...
{
    private function covers(float $paid, ?string $currency): bool
    {
    ...
    public function test_absent_amount_is_allowed_to_avoid_false_blocks(): void
    {
        $this->assertTrue($this->covers(0.0, null));
    }
