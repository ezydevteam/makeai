...
class LicenseServiceTest extends TestCase
{
    ...
    public function test_install_wizard_license_step_checks_license_without_writing_to_database(): void
    {
        ...
        // The wizard reordered in 83849a2e: License moved ahead of Database, so
        // the licence check is step 2 and only the requirements step precedes it.
        $sessionData = [
            'current_step' => 2,
            'steps_completed' => [1],
            'data' => [
        ...
        $this->assertNotNull($updatedSession['data']['step_2']['license_result']);
        $this->assertEquals(1, $updatedSession['data']['step_2']['license_result']['type']);
    ...
    public function test_manual_activation_via_controller_succeeds_with_valid_license(): void
    {
        ...
        $response = $this->actingAs($admin, 'admin')
            ->post('/admin/system/license/activate', [
                'purchase_code' => '12345678-1234-1234-1234-123456789012',
            ]);
