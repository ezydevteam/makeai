...
namespace Addons\AiKnowledgeBase\Services;

use Addons\AiKnowledgeBase\Models\KbArticle;
use Addons\AiKnowledgeBase\Models\KbEmbedding;
...
class KbSearchService
{
    ...
    public function searchAndAnswer(
        ...
        $topK = (int) addon_setting('ai-knowledge-base', 'top_k', 5);
        ...
        $maxTokens = (int) addon_setting('ai-knowledge-base', 'max_answer_tokens', 512);
        ...
        $persona = trim((string) addon_setting('ai-knowledge-base', 'system_prompt', ''));
        if ($persona === '') {
        ...
        $providerName = addon_setting('ai-knowledge-base', 'provider');
