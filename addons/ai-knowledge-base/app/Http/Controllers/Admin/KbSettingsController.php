...
use Addons\AiKnowledgeBase\Http\Requests\Admin\KbSettingsRequest;
...
class KbSettingsController extends Controller
{
    ...
    {
        $settings = [
            'enabled' => addon_setting('ai-knowledge-base', 'enabled', true),
            ...
            'show_vote_buttons' => addon_setting('ai-knowledge-base', 'show_vote_buttons', true),
            'allow_guest_search' => addon_setting('ai-knowledge-base', 'allow_guest_search', true),
            'widget_enabled' => addon_setting('ai-knowledge-base', 'widget_enabled', false),
            'widget_accent_color' => addon_setting('ai-knowledge-base', 'widget_accent_color', '#10b981'),
            'ai_model' => addon_setting('ai-knowledge-base', 'ai_model', ''),
            'top_k' => addon_setting('ai-knowledge-base', 'top_k', 5),
            'max_answer_tokens' => addon_setting('ai-knowledge-base', 'max_answer_tokens', 512),
            'provider' => addon_setting('ai-knowledge-base', 'provider', ''),
            'system_prompt' => addon_setting('ai-knowledge-base', 'system_prompt', ''),
        ];
        ...
        return Inertia::render('Addons/ai-knowledge-base/Admin/Settings', [
            'settings' => $settings,
            'providers' => $providers,
            'menus' => $menus,
        ]);
    ...
    public function update(KbSettingsRequest $request)
    {
        ...
        foreach ($validated as $key => $value) {
            addon_setting_set('ai-knowledge-base', $key, $value);
        }
