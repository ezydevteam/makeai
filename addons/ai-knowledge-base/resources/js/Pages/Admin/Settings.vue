...
const saveLogo = () => {
    logoForm.post(route('admin.addons.settings.save', { slug: 'ai-knowledge-base' }), {
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
            ...
            <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-surface-800 dark:bg-gray-900">
                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    ...
                    <div class="flex items-center justify-between gap-4 rounded-xl border border-gray-100 bg-gray-50/70 p-4 dark:border-surface-800 dark:bg-surface-800/60">
                        ...
                        <AppSwitch v-model="form.show_vote_buttons" />
                    </div>
                    ...
                    <div class="flex items-center justify-between gap-4 rounded-xl border border-gray-100 bg-gray-50/70 p-4 dark:border-surface-800 dark:bg-surface-800/60">
                        ...
                        <AppSwitch v-model="form.allow_guest_search" />
                    </div>
                </div>
            </section>
            ...
            <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-surface-800 dark:bg-gray-900">
                ...
                <div class="grid gap-4 lg:grid-cols-2">
                    <div class="flex items-center justify-between gap-4 rounded-xl border border-gray-100 bg-gray-50/70 p-4 dark:border-surface-800 dark:bg-surface-800/60">
                        ...
                        <AppSwitch v-model="form.widget_enabled" />
                    </div>
