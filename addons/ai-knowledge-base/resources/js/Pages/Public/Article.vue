...
// The TechArticle JSON-LD now comes from the server (KbArticleController::articleSchema,
// emitted by app.blade.php), so crawlers see it without running JS and it carries url +
// dateModified this client-side copy never had. Rebuilding a thinner one here would put a
// second, contradicting schema in the DOM.
</script>
