...
class ProviderOperationService
{
    ...
    public function run(AipJob $job): array
    {
        ...
        $mask = $job->mask_path ? $this->bytesOf('public', $job->mask_path, translate('The mask image could not be read.')) : null;
        $reference = $job->reference_path ? $this->bytesOf('public', $job->reference_path, translate('The reference image could not be read.')) : null;
