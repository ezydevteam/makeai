...
class GenerationService
{
    ...
    {
        // resolveSlug, not resolveAlias: the job recorded our internal slug when it was
        // queued, and that is what it must generate with.
        $model = $this->catalog->resolveSlug($job->model);
        $user = $job->user;
