...
const selectedModel = ref<string | null>(props.defaultModel ?? props.models[0]?.id ?? null)
...
const activeModel = computed<ModelOption | null>(
    () => props.models.find((model) => model.id === selectedModel.value) ?? null,
)
                            ...
                            >
                                <li v-for="model in models" :key="model.id">
                                    ...
                                    >
                                        ...
                                        <i v-if="model.id === selectedModel" class="ti ti-check shrink-0 text-sm"></i>
                                    </button>
                                </li>
                            </ul>
                        </div>
