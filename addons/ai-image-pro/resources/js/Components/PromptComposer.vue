...
const selectedModelId = ref<string | null>(props.defaultModel ?? props.models[0]?.id ?? null)
...
function submit(): void {
    ...
    if (props.allowModelChoice && selectedModelId.value) payload.model = selectedModelId.value
