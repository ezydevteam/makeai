...
class AiAssistantController extends Controller
{
    ...
    public function helpArticles(Request $request): JsonResponse
    {
        ...
        $articles = \Addons\AiKnowledgeBase\Models\KbArticle::query()
            ->published()
    ...
    public function helpArticle(Request $request, string $slug): JsonResponse
    {
        ...
        $article = \Addons\AiKnowledgeBase\Models\KbArticle::query()
            ->published()
            ->where('slug', $slug)
            ->first();
        ...
        $related = [];
        try {
            $related = app(\Addons\AiKnowledgeBase\Services\KbSearchService::class)
